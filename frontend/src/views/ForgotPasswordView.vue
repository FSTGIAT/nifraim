  ...
  <div class="auth-split">
    ...
    <div class="auth-brand-panel">
      <div class="brand-content">
        ...
        <h1 class="brand-heading">איפוס סיסמה</h1>
        <p class="brand-subtitle">נשלח לך קישור לאיפוס הסיסמה לאימייל שלך</p>
    ...
    <div class="auth-form-panel">
      <div class="form-content">
        <template v-if="!sent">
        <h2 class="form-heading">איפוס סיסמה</h2>
...
@media (max-width: 768px) {
  ...
  .brand-subtitle { font-size: 15px; margin-bottom: 24px; }
