...
const ICONS = {
  ...
  mail:     '<path d="M13 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2v-6"/><path d="M2 7l8.97 5.7a1.94 1.94 0 002.06 0L16.5 10"/><path fill="currentColor" stroke="none" d="M19 1c.34 2.2 1.3 3.16 3.5 3.5-2.2.34-3.16 1.3-3.5 3.5-.34-2.2-1.3-3.16-3.5-3.5C17.7 4.16 18.66 3.2 19 1Z"/>',
  Mail:     '<path d="M13 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2v-6"/><path d="M2 7l8.97 5.7a1.94 1.94 0 002.06 0L16.5 10"/><path fill="currentColor" stroke="none" d="M19 1c.34 2.2 1.3 3.16 3.5 3.5-2.2.34-3.16 1.3-3.5 3.5-.34-2.2-1.3-3.16-3.5-3.5C17.7 4.16 18.66 3.2 19 1Z"/>',
