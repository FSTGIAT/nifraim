      ...
      <div v-if="productionStore.uploading" class="upload-loading">
        <div class="loading-content">
          ...
          <div class="loading-info">
            <span class="loading-text">{{ uploadStageLabel }}</span>
            <span class="loading-hint">{{ uploadStageHint }}</span>
          </div>
        </div>
...
.upload-btn:hover {
  ...
  box-shadow: 0 8px 24px rgba(47, 115, 196, 0.25);
}
...
.loader-ring.delay {
  inset: 4px;
  border-top-color: var(--accent-cyan, var(--accent-emerald));
